...
$reqt=$bdd->prepare('SELECT* FROM g_messagerie WHERE (lire=:a || lire=:b )');
$reqt->execute(array("a"=>"lu",
                    "b"=>"rep"
));
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-lg-3">
                            <div class="statistic__item statistic__item--blue">
                                <h2 class="number"><?php echo nombre_messach($base);?></h2>
                                <span class="desc">Messages Archivés</span>
                                <div class="icon">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="table-data__tool">
                                <div class="table-data__tool-left">
                                    ...
                                    <div class="rs-select2--light rs-select2--sm">
                                        <button class="item" data-toggle="tooltip" data-placement="top" title="Supprimer les selections">
                                ...
                                <table class="table table-data2">
                                    ...
                                    <?php while($new=$reqt->fetch()) { $idt=$new['idp'];?>
                                        <tr class="tr-shadow">
                                            ...
                                            <td>
                                                <?php if( $new['lire']=="lu" )  {?>
                                                <span class="status--process">Lu</span>
                                                <?php }else{ ?>
